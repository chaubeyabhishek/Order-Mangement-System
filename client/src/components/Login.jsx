    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg-primary)', padding: '60px 40px' }}>
      <div style={{ maxWidth: '900px', margin: '0 auto' }}>
        ...
        <div className="card" style={{ maxWidth: '400px', padding: '30px' }}>
          ...
          <p style={{ marginBottom: '20px', color: 'var(--muted)' }}>Access your account with role-based permissions.</p>
          ...
          <form onSubmit={handleSubmit} className="grid auth-form">
            ...
            <input
              ...
              required
            />
            <button className="btn" type="submit" style={{ marginTop: '10px' }}>Login</button>
          </form>
          <p style={{ marginTop: '20px', fontSize: '14px' }}>
            New user? <Link to="/register" style={{ color: 'var(--primary)' }}>Register here</Link>
          </p>
        </div>
      </div>
    </div>
